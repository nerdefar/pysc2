#From: https://github.com/neka-nat/async-rl-noreward
# Will hopefully be edited to run with pysc2.
...
# Class for the actual learning agent
...
def learn_proc(mem_queue, weight_dict):
    ...
    try:
        ...
        agent = LearningAgent(env.action_spec(), batch_size=args.batch_size, swap_freq=args.swap_freq)
    ...
    actions = np.zeros((batch_size, env.action_spec().num_discrete_space), dtype=np.int32)
